    ...
    if row_count == 0:
        ...
        try:
            ...
            if not check_collection_exists(collection_name):
                ...
                id_field = FieldSchema(name="id", dtype=DataType.VARCHAR, max_length=100, is_primary=True, auto_id=False)  # 改为VARCHAR类型
            ...
            # 插入数据，ID使用字符串类型
            collection.insert([
                {"id": "test_id_001", "vector": test_vector, "text": test_text}
            ])
